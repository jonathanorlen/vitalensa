  ...
  <div class="pageheader">
    ...
    <div class="page-bar">
      ...
      <ul class="page-breadcrumb">
        ...
        <li>
          <a href="<?php echo base_url().'admin/berita'?>">Renungan</a>
        </li>
        <li>
          <a href="#">Ubah Renungan</a>
        </li>
      </ul>
      ...
      <div class="col-md-8 col-xs-12 pull-left">
        ...
        <div class="tile">
          ...
          <div class="tile-header dvd dvd-btm bg-blue">
            <h1 class="custom-font"><i class="fa fa-pencil"></i> <strong>Ubah</strong> Tulis Renungan</h1>
          </div>
          <div class="tile-body">
...
<script type="text/javascript">
 $("#data_form").submit( function() {    
  ...
  $.ajax( {  
   type :"post",  
   method: 'POST',
   url : "<?php echo base_url() . 'admin/renungan/simpan_ubah' ?>",  
   cache :false,  
   contentType: false,
   processData: false,
   data :formData,
   success : function(data) {  
    if(data == 1){
      ...
      setTimeout(function(){
        window.location = "<?php echo base_url() . 'admin/renungan' ?>";
      }   ,1500);  
    }else{
