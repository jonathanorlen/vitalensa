...
class renungan extends CI_Controller {
	...
	{	
		$data['menu'] = 'renungan';
		$data['konten'] = $this->load->view('renungan/daftar', NULL, TRUE);
	...
	{	
		$data['menu'] = 'renungan';
		$data['konten'] = $this->load->view('renungan/ubah', NULL, TRUE);
		$this->load->view ('main', $data);
	}
	...
	{	
		$data['menu'] = 'berita';
		$data['konten'] = $this->load->view('renungan/tambah', NULL, TRUE);
		$this->load->view ('main', $data);
	}
