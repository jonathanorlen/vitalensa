  ...
  <div class="pageheader">
    ...
    <div class="page-bar">
      ...
      <ul class="page-breadcrumb">
        ...
        <li>
          <a href="<?php echo base_url().'admin/aktivitas'?>">Aktivitas</a>
        </li>
        <li>
          <a href="#">Ubah Aktivitas</a>
        </li>
      </ul>
      ...
      <div class="col-md-8 col-xs-12 pull-left">
        ...
        <div class="tile">
          ...
          <div class="tile-header dvd dvd-btm bg-blue">
            <h1 class="custom-font"><i class="fa fa-pencil"></i> <strong>Ubah</strong> Tulis Aktivitas</h1>
          </div>
          <div class="tile-body">
        ...
        <div class="tile">
          ...
          <ul class="fa-ul" style="margin-left:50px">
            <li id="list_judul_berita" style="color:#36de02">
              <h4>
                <i class="fa-li fa fa-check" id="icon_judul_berita"></i>Judul Aktivitas <small>( 15 Huruf )</small>
              </h4>
            </li>
...
<script type="text/javascript">
 $("#data_form").submit( function() {    
  ...
  $.ajax( {  
   type :"post",  
   method: 'POST',
   url : "<?php echo base_url() . 'admin/aktivitas/simpan_ubah' ?>",  
   cache :false,  
   contentType: false,
   processData: false,
   data :formData,
   success : function(data) {  
    if(data == 1){
      ...
      setTimeout(function(){
        window.location = "<?php echo base_url() . 'admin/aktivitas' ?>";
      }   ,1500);  
    }else{
