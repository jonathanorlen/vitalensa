  ...
  <div class="pageheader">
    ...
    <div class="page-bar">
      ...
      <ul class="page-breadcrumb">
        ...
        <li>
          <a href="<?php echo('opini')?>">Opini</a>
        </li>
        <li>
          <a href="#">Tulis Opini</a>
        </li>
      </ul>
      ...
      <div class="col-md-8 col-xs-12 pull-left">
        ...
        <div class="tile">
          ...
          <div class="tile-header dvd dvd-btm bg-blue">
            <h1 class="custom-font"><strong> <i class="fa fa-pencil"></i> Tulis Opini</strong></h1>
          </div>
          <div class="tile-body">
...
<script type="text/javascript" src="<?php echo base_url().'javascript/opini.js'?>"></script>
...
<script type="text/javascript">
  ...
  $("#data_form").submit( function() {    
    ...
    $.ajax( {  
     type :"post",  
     method: 'POST',
     url : "<?php echo base_url() . 'admin/opini/simpan_tambah' ?>",  
     cache :false,  
     contentType: false,
     processData: false,
     data :formData,
     success : function(data) {  
      if(data == 1){
        ...
        setTimeout(function(){ x.className = x.className.replace("show", ""); }, 5000);
          ...
          setTimeout(function(){
            window.location = "<?php echo base_url() . 'admin/opini/daftar' ?>";}  ,1500);  
      }else{
