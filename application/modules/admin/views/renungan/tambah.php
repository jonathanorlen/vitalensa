  ...
  <div class="pageheader">
    ...
    <div class="page-bar">
      ...
      <ul class="page-breadcrumb">
        ...
        <li>
          <a href="<?php echo('renungan')?>">Berita</a>
        </li>
        <li>
          <a href="#">Tulis Renungan</a>
        </li>
      </ul>
      ...
      <div class="col-md-8 col-xs-12 pull-left">
        ...
        <div class="tile">
          ...
          <div class="tile-header dvd dvd-btm bg-blue">
            <h1 class="custom-font"><strong> <i class="fa fa-pencil"></i> Tulis Renungan</strong></h1>
          </div>
          <div class="tile-body">
...
<script type="text/javascript">
  ...
  $("#data_form").submit( function() {    
    ...
    $.ajax( {  
     type :"post",  
     method: 'POST',
     url : "<?php echo base_url() . 'admin/renungan/simpan_tambah' ?>",  
     cache :false,  
     contentType: false,
     processData: false,
     data :formData,
     success : function(data) {  
      if(data == 1){
        ...
        setTimeout(function(){ x.className = x.className.replace("show", ""); }, 5000);
          ...
          setTimeout(function(){
            window.location = "<?php echo base_url() . 'admin/renungan/daftar' ?>";}  ,1500);  
      }else{
